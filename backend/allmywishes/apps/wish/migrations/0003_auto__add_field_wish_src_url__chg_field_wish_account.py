...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Wish.src_url'
        db.add_column(u'wish_wish', 'src_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Wish.account'
        db.alter_column(u'wish_wish', 'account_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Account']))

    def backwards(self, orm):
        # Deleting field 'Wish.src_url'
        db.delete_column(u'wish_wish', 'src_url')


        # Changing field 'Wish.account'
        db.alter_column(u'wish_wish', 'account_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
