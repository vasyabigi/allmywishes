...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Wish', fields ['title']
        db.create_index(u'wish_wish', ['title'])


    def backwards(self, orm):
        # Removing index on 'Wish', fields ['title']
        db.delete_index(u'wish_wish', ['title'])

        # Deleting field 'Wish.created'
        db.delete_column(u'wish_wish', 'created')
    ...
    models = {
        ...
        'wish.wish': {
            ...
            'account': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
