...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Wish.title'
        db.alter_column(u'wish_wish', 'title', self.gf('django.db.models.fields.CharField')(default='pohyi', max_length=100))

    def backwards(self, orm):

        # Changing field 'Wish.title'
        db.alter_column(u'wish_wish', 'title', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
